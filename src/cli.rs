...
enum Command {
    ...
    Init {
        /// Target vendor(s): claude, codex, copilot, cursor and/or gemini. Repeatable or comma-separated.
...
enum TargetCommand {
    ...
    /// configured.
    Add {
        /// Vendor(s) to add: claude, codex, copilot, cursor and/or gemini. Repeatable or
