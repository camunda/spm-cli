...
AI coding tools — Claude Code, GitHub Copilot CLI — load "skills" from specific
directories in your project. If you want a team to share a set of skills, you are
usually left with bad options:
