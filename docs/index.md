...
hero:
  ...
  tagline: Declare AI skills as git dependencies in ai.json and materialize them for Claude Code and GitHub Copilot CLI — without ever committing skills to your repo.
  image:
    src: /logo.svg
    alt: spm logo
  actions:
...
features:
  ...
  - icon: 🛠️
    ...
    details: One declaration resolves once and projects independently into Claude Code and GitHub Copilot CLI, each in the project-local location that vendor expects.
  - icon: ♻️
