...
<!--
  A short summary — one or two sentences.
...
<!-- The problem this solves or the value it adds. Skip if it's clear from the linked issue. -->
...
<!-- Be explicit if this doesn't apply -->
